    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        style: ElevatedButton.styleFrom(
          ...
          side: BorderSide(width: borderWidth, color: borderColor ?? Colors.black, style: borderStyle),
        ...
        child: Row(
          ...
          children: [
            if (leadingIcon != null) ...[
              Padding(
                padding: EdgeInsets.only(left: leadingIconPaddingLeft, right: leadingIconPaddingRight),
                child: Icon(leadingIcon!, size: iconSize),
              ),
            ],
            Expanded(child: Center(child: Text(text, style: textStyle))), // Set the text style
            if (trailingIcon != null) ...[
              Padding(
                padding: EdgeInsets.only(left: trailingIconPaddingLeft, right: trailingIconPaddingRight),
