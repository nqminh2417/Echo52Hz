...
class SmtsProgressModel {
  ...
  factory SmtsProgressModel.fromJson(String source) => SmtsProgressModel.fromMap(json.decode(source) as Map<String, dynamic>);
...
class Depts {
  ...
  bool operator ==(covariant Depts other) {
    ...
    return other.art == art && other.posing == posing && other.dialogue == dialogue && other.code == code && other.audio == audio;
  }
...
class Totals {
  ...
  bool operator ==(covariant Totals other) {
    ...
    return other.totalsNew == totalsNew && other.closed == closed && other.working == working && other.total == total && other.percent == percent;
  }
