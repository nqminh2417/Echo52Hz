...
/// https://youtu.be/HyAeZKWWuxA?si=juo3MSBlHt_YpD4-
...
class ClockPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (var i = 1; i <= 12; i++) {
      var numberAngle = -pi / 2 + anglePerNumber * i; // Subtract pi/2 to start from the top
      ...
      numberTextPainter.paint(
          canvas, Offset(-numberTextPainter.width / 2, -numberTextPainter.height / 2)); // Paint the number
